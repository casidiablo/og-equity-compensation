...
These are a few topics that are not essential knowledge for most employees, but we mention for completeness.

- [**Phantom equity**](http://www.investopedia.com/articles/stocks/12/introduction-phantom-stock.asp) (or **phantom stock**) is another type of compensation. It is not especially common, but you may encounter it. It’s called “phantom” because it is not really equity at all: It is a contractual promise to make a cash payment, the amount of which is determined by reference to the value of the company’s stock.
